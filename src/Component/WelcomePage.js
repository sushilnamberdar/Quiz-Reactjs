...
const WelcomePage = ({ onQuestionsUpdate }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <a href="https://www.linkedin.com/in/sushilnamberdar" target="_blank" rel="noopener noreferrer" className="inline-block mt-2">
        <div className=" rounded-[50%]  p-2 inline-block">
